...
## Required script
source("~/Desktop/Research/Tentative Results-Proj2/R scripts/requiredPackages.R")
# source("~/Downloads/LKrigSimSAR.R")
# source("~/LKrigSARPareto.R")
source("~/Desktop/Research/Tentative Results-Proj2/R script/LKrigSAREvd.R")
...
lambdaGrid <- 10^(runif(n=n_full, log10(0.00001), log10(0.1)))
summary(lambdaGrid)
hist(lambdaGrid)
...
save(storeParameterRep, 
     file="ParameterConfiguration-Jan17-Train-Rep30.RData")


dim(storeZRep)
save(storeZRep, file="storeZRep-Jan17-Train-Rep30.RData")
